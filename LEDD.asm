...
; FOI CRIADO QUATRO MACROS QUE SÃO BLOCOS DE CÓDIGOS
...
START
    ...
    ; BCF STATUS , RP1
    ; BSF (BIT SET F): SETA O BIT NO ENDEREÇO "STATUS"
    ; BSF STATUS , RP0 
    
    BANK1
    ; CLRF = APAGA UMA POSIÇÃO NA MEMÓRIA DE DADOS   
...
MAIN_LOOP
    ; MOVLW = MOVA UM LITERAL PARA UM TEMPORÁRIO
    MOVLW B'11110000'
    MOVWF PORTB    
    MOVWF PORTD  
    CALL DELAY
